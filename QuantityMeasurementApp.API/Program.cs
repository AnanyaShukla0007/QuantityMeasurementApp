...
using (var scope = app.Services.CreateScope())
{
    try
    {
        ...
        CREATE TABLE IF NOT EXISTS ""Measurements"" (
            ...
            ""MeasurementCategory"" integer NOT NULL,
            ""Operand1Value"" double precision NOT NULL,
            ""Operand1Unit"" text NOT NULL,
            ""Operand2Value"" double precision NOT NULL,
            ""Operand2Unit"" text NOT NULL,
