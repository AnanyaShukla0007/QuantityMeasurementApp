...
namespace QuantityMeasurementApp.Menu
{
    public class ConsoleMenu
    {
        ...
        private void HandleLengthConversion()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Original Measurement:");
            ...
            var result = quantity.ConvertTo(to);

            Console.WriteLine();
            Console.WriteLine($"Converted: {result.Value} {result.Unit.GetUnitName()}");
        ...
        private void HandleWeightConversion()
        {
            ...
            var quantity = new Quantity<WeightUnit>(value, from);
            var result = quantity.ConvertTo(to);
        ...
        private void HandleTemperatureConversion()
        {
            ...
            var quantity = new Quantity<TemperatureUnit>(value, from);
            var result = quantity.ConvertTo(to);
