    ...
    public class QuantityMeasurementServiceImpl : IQuantityMeasurementService
    {
        ...
        public QuantityResponse CompareQuantities(BinaryQuantityRequest request)
        {
            try
            {
                ...
                var entity = new QuantityMeasurementEntity
                {
                    ...
                    Operand1Unit = request.Quantity1.Unit.ToString(),

                    Operand2Value = request.Quantity2.Value,
                    Operand2Unit = request.Quantity2.Unit.ToString(),
        ...
        public QuantityResponse ConvertQuantity(ConversionRequest request)
        {
            try
            {
                ...
                double result = request.Source.Value; // placeholder conversion logic
                ...
                var entity = new QuantityMeasurementEntity
                {
                    ...
                    Operand1Unit = request.Source.Unit.ToString(),

                    Operand2Value = 0,
                    Operand2Unit = "",

                    ResultValue = result,
                    ResultUnit = request.TargetUnit.ToString()
                };
        ...
        public QuantityResponse AddQuantities(BinaryQuantityRequest request)
        {
            try
            {
                ...
                var entity = new QuantityMeasurementEntity
                {
                    ...
                    ResultValue = result,
                    ResultUnit = request.Quantity1.Unit.ToString()
                };

                _repository.Save(entity);
                Console.WriteLine("Saved Successfully"+response);
                return response;
            }
            catch (Exception ex)
            {
